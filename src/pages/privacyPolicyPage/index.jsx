      ...
      <div className='container mx-auto'>
        <div className='flex flex-col item-center justify-center gap-10 py-32 px-10 min-h-70vh'>
          <div className='max-w 3xl h-auto text-left'>
            <h3 className='text-black'>Privacy Policy</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to TMT.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to TMT, accessible from{' '}
                  <a
                    href='d-tmt.com'
            ...
            <ul>
              <li>By email: tmtd.tang@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
